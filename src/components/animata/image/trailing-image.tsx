...
const TrailingImage = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="storybook-fix bg-[#FAF6F6] relative flex min-h-screen w-full"
    >
      ...
      <div className="flex w-full flex-1 items-center justify-center p-4 text-center text-3xl text-foreground md:text-9xl">
        <div className="uppercase ">Rhidya Gupta</div>
      </div>
    </div>
  );
};
